...
const OpenSource = () => {
  ...
  return (
    <section className="bc-OpenSource bc-section" id="openSource">
      <div className="bc-os-content" ref={revealRef}>
        ...
        <div className="bc-os-ctas">
          <a href="https://github.com/sunny8080/BaatChat" title="GitHub repo link" className="bc-btn bc-btn-primary">
            ⭐ Star on GitHub
          </a>
